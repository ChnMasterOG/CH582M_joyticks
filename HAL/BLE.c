...
uint8_t BLE_status = BLE_STATUS_UNCONNECTED;
...
static uint8_t advertData[] = {
    ...
    LO_UINT16(GAP_APPEARE_HID_JOYSTIC),
    HI_UINT16(GAP_APPEARE_HID_JOYSTIC)};

// Device name attribute value
static CONST uint8_t attDeviceName[GAP_DEVICE_NAME_LEN] = "TP78Joy";
