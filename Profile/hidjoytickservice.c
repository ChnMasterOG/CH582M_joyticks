/********************************** (C) COPYRIGHT *******************************
 * File Name          : hidjoyticksservice.c
 * Author             : WCH
 * Version            : V1.0
 * Date               : 2023/11/11
 * Description        : joytick service
 *********************************************************************************
 * Copyright (c) 2023 ChnMasterOG Co., Ltd.
...
static const uint8_t hidReportMap[] = {
    ...
    0x95, 0x06, // REPORT_COUNT (6) - Моід8bit
...
// HID Report characteristic, Joytick input
static uint8_t       hidReportJoytickInProps = GATT_PROP_READ | GATT_PROP_NOTIFY;
static uint8_t       hidReportJoytickIn;
static gattCharCfg_t hidReportJoytickInClientCharCfg[GATT_MAX_NUM_CONN];

// HID Report Reference characteristic descriptor, joytick input
static uint8_t hidReportRefJoytickIn[HID_REPORT_REF_LEN] =
    {HID_RPT_ID_JOYTICK_IN, HID_REPORT_TYPE_INPUT};
...
static gattAttribute_t hidAttrTbl[] = {
    ...
    // HID Report characteristic, joytick input declaration
    {
        {ATT_BT_UUID_SIZE, characterUUID},
        GATT_PERMIT_READ,
        0,
        &hidReportJoytickInProps},
    ...
    // HID Report characteristic client characteristic configuration
    {
        ...
        0,
        (uint8_t *)&hidReportJoytickInClientCharCfg},
...
enum
{
    ...
    HID_REPORT_JOTICK_IN_DECL_IDX,  // HID Report characteristic, jotick input declaration
    HID_REPORT_JOTICK_IN_IDX,       // HID Report characteristic, jotick input
    HID_REPORT_JOTICK_IN_CCCD_IDX,  // HID Report characteristic client characteristic configuration
    HID_REPORT_REF_JOYTICK_IN_IDX,  // HID Report Reference characteristic descriptor, mouse input
...
bStatus_t Hid_AddService(void)
{
    ...
    GATTServApp_InitCharCfg(INVALID_CONNHANDLE, hidReportJoytickInClientCharCfg);
    ...
    // joytick input report
    hidRptMap[0].id = hidReportRefJoytickIn[0];
    hidRptMap[0].type = hidReportRefJoytickIn[1];
    hidRptMap[0].handle = hidAttrTbl[HID_REPORT_JOTICK_IN_IDX].handle;
    hidRptMap[0].cccdHandle = hidAttrTbl[HID_REPORT_JOTICK_IN_CCCD_IDX].handle;
