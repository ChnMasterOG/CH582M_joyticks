...
typedef struct {
    ...
    uint8_t sw_x_mirror_flag;
    uint8_t sw_y_mirror_flag;
    uint8_t sw_axis_mirror_flag;
    float pitch_sensitivity;
    float roll_sensitivity;
    float pitch_mid;
    float roll_mid;
    uint8_t gyro_key_enable;
    uint8_t gyro_x_mirror_flag;
    uint8_t gyro_y_mirror_flag;
    uint8_t gyro_axis_mirror_flag;
